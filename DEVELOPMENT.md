...
```bash
git remote add encore encore://anurag-portfolio-qbti
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/anurag-portfolio-qbti/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/anurag-portfolio-qbti/settings/integrations/github)
